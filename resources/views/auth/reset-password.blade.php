...
@section('title', 'Reset Password - Kos Putri Ayuni')
            ...
            <div class="relative z-10 flex h-full flex-col justify-between p-10 xl:p-14">
                <a href="{{ route('home') }}" class="inline-flex w-fit items-center gap-3 text-white">
                    ...
                    <span>
                        ...
                        <span class="block text-sm text-white/75">Reset password</span>
                    </span>
                </a>

                <div class="max-w-xl text-white">
                    <p class="mb-4 inline-flex rounded-lg bg-white/12 px-4 py-2 text-sm font-semibold ring-1 ring-white/20">Keamanan akun</p>
                    <h1 class="font-outfit text-5xl font-bold leading-tight xl:text-6xl">Buat password baru untuk akunmu.</h1>
                    <p class="mt-5 max-w-lg text-lg leading-8 text-white/78">Masukkan password baru yang kuat dan mudah diingat.</p>
                </div>

                <div class="rounded-lg bg-white/12 p-5 text-white ring-1 ring-white/18">
                    <p class="text-sm leading-6 text-white/78">Pastikan password baru minimal 8 karakter untuk keamanan optimal.</p>
                </div>
            </div>
        </section>
        ...
        <main class="flex min-h-screen items-center justify-center px-5 py-8 sm:px-8 lg:px-12">
            <div class="w-full max-w-md">
                ...
                <div class="rounded-lg bg-white p-6 shadow-xl shadow-slate-900/8 ring-1 ring-slate-200 sm:p-8">
                    <div class="mb-8">
                        <p class="mb-2 text-sm font-semibold uppercase tracking-[0.18em] text-[#b9854d]">Reset password</p>
                        <h2 class="font-outfit text-3xl font-bold text-slate-950">Buat password baru</h2>
                        <p class="mt-2 text-sm leading-6 text-slate-600">Masukkan email dan password baru Anda.</p>
                    </div>
